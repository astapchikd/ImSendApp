...
QT_MOC_LITERAL(1, 11, 29), // "slotUpdateLineNumberAreaWidth"
QT_MOC_LITERAL(2, 41, 0), // ""
QT_MOC_LITERAL(3, 42, 13), // "newBlockCount"
QT_MOC_LITERAL(4, 56, 24), // "slotHighlightCurrentLine"
QT_MOC_LITERAL(5, 81, 24), // "slotUpdateLineNumberArea"
QT_MOC_LITERAL(6, 106, 17) // "slotOnTextChanged"

    },
    "CodeEditor\0slotUpdateLineNumberAreaWidth\0"
    "\0newBlockCount\0slotHighlightCurrentLine\0"
    "slotUpdateLineNumberArea\0slotOnTextChanged"
};
...
void CodeEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotUpdateLineNumberAreaWidth((*reinterpret_cast< qint32(*)>(_a[1]))); break;
        case 1: _t->slotHighlightCurrentLine(); break;
        case 2: _t->slotUpdateLineNumberArea((*reinterpret_cast< const QRect(*)>(_a[1])),(*reinterpret_cast< qint32(*)>(_a[2]))); break;
        case 3: _t->slotOnTextChanged(); break;
        default: ;
        }
    }
}
